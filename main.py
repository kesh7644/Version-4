...
class end:
  ...
  def __init__(self):
      ...
      self.end_heading = Label(window2,text='Nice try, you finished the quiz ', font=('Tw Cen Mt', 22, 'bold'), bg=background_color)
      ...
      self.list_label = Label(window2, text='Feel free to try again', font=('Tw Cen Mt', 12, 'bold'), width=40, bg=background_color)
